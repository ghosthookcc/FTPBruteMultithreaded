...
namespace WebCamService
{
	...
	public class FtpClient
	{
		...
		public void Login()
		{
			...
			{
				this.Close();
				throw new FtpException(this.resultCode.ToString());
			}
		...
		public string[] GetFileList(string mask)
		{
			...
			if(!(this.resultCode == 150 || this.resultCode == 125)) throw new FtpException(this.result.ToString());
		...
		public long GetFileSize(string fileName)
		{
			...
			if ( this.resultCode == 213 )
				size = long.Parse(this.result.ToString());

			else
				throw new FtpException(this.result.ToString());
		...
		public void Upload(string fileName, bool resume)
		{
			...
			if( this.resultCode != 226 && this.resultCode != 250 ) throw new FtpException(this.result.ToString());
		}
		...
		public void DeleteFile(string fileName)
		{
			...
			if ( this.resultCode != 250 ) throw new FtpException(this.result.ToString());
		...
		public void RenameFile(string oldFileName,string newFileName, bool overwrite)
		{
			...
			if ( this.resultCode != 350 ) throw new FtpException(this.result.ToString());
		...
		public void MakeDir(string dirName)
		{
			...
			if ( this.resultCode != 250 && this.resultCode != 257 ) throw new FtpException(this.result.ToString());
		...
		public Socket createDataSocket()
		{
			...
			if ( this.resultCode != 227 ) throw new FtpException(this.result.ToString());
